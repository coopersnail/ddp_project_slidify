...
require(rCharts)
require(knitr) # needed otherwise there will be an error about missing 'opts_current'
...
#                 numericInput('age', strong('your current age'), 20, min=10, max=100, step=1),
#                 p('Please select the chart type.'),
#                 selectInput('chart_type', strong('chart type'), 
#                             c("stacked area chart", "pie chart")),
#                 p('Press the Submit button after you input the information.'),
#                 submitButton('Submit')
#                 ),
#         
#         mainPanel(
#                 tag$div(id = 'investChart', class = 'shiny-html-output nvd3 rCharts')
#                 )
#         )
